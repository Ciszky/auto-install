...
yay -S visual-studio-code-bin spotify freeoffice onlyoffice-bin bpytop mangohud-git gzdoom-bin raze-bin ttf-dejavu openrgb minecraft-launcher pnpm yt-dlp raze-bin caprine protontricks qemu docker vpcs dynamips libvirt ubridge inetutils gns3-server gns3-gui update-grub kvantum-qt6-git librewolf-bin vesktop-bin pycharm-professional intellij-idea-ultimate-edition intellij-idea-ultimate-edition-jre heroic-games-launcher protonup-qt
check_success
